...
if (!preg_match("/^[0-9a-zA-Z���_.-]+@[0-9a-z.-]+\.[a-z]{2,6}$/", $email)) {
   ...
   $msg = strip_tags ($msg);
   $dsubject = "Testmail";
   $dmailheaders = "From: <no-reply@yellabook.de>\n";
   $dmailheaders .= "Reply-To: <no-reply@yellabook.de>\n";
   $dmsg  = "If you can read this email the php mail function has been successfully tested on your server!\n\n";
   $dmsg .= "You can now delete the file mail-test.php and use the guestbook YellaBook. ";
...
<meta name="description"      content="yellabook.de"/>
...
.kontaktformular a:hover {color: #DEF1FE;}
...
<p><b>Formular for testing the php mail functions on your server.</b><br /><p>Please enter your <b>E-Mail Adress</b> and click on <b>send</b>.<br /><br />Within a few seconds you should receive an email. <br />This file can be deleted afterwards.</p>
...
<fieldset class="kontaktdaten">
    <legend>TEST - PHP Mail Function</legend>
	<table>
		<tr>
